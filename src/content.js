const defaultContent = {
  site: {
    ...
    logo: "/logo2.png",
    contactEmail: "act4lab@example.com",
    contactAddress: "湖北武汉\nACT IV 未来视觉研究室",
  ...
  news: [
    {
      title: "未来视觉研究室",
      text: "面向数字时代的未来视觉研究室，聚焦视觉系统、动态叙事、交互体验与跨媒介实验。",
      date: "2026-05",
    },
    {
      title: "创造性融合",
      text: "以设计思维连接真实场景，让图像、界面、空间与智能生成共同形成可落地的视觉方案。",
      date: "ACT 00",
    },
    {
      title: "突破第四堵墙",
      text: "突破屏幕、身体、场域与媒介之间的边界，建立更开放的视觉感知与表达方式。",
      date: "LAB NOTE",
    },
  ],
  works: [
  ...
  projects: [
    "品牌识别系统、版式结构、包装逻辑与界面视觉规范",
    "动态视觉设计、短视频影像系统、生成式节奏与 MG 动画",
    "用户体验研究、交互原型、空间界面与响应式服务流程",
    "AIGC 辅助设计、多模态内容、投影映射与跨媒介视觉场",
  ],
  archive: [
    ["动作链", "凝视 -> 流动 -> 对话 -> 破墙"],
    ["状态链", "秩序 -> 叙事 -> 共生 -> 融合"],
  ...
  people: [
    ["静态视觉系统", "建立品牌、版式、界面与图像秩序的基础语言。"],
    ["动态叙事", "把图像带入时间、节奏、声音与生成影像的复合关系。"],
    ["交互体验", "让观看转化为回应，在界面、空间与行为之间建立对话。"],
    ["未来媒介", "探索 AI、多模态、投影映射与跨媒介视觉现场。"],
  ],
  boardRows: [
    ["2026-05", "研究室视觉系统更新", "完成 ACT IV 暗黑版网站主视觉与二级页面结构。"],
    ["2026-05", "跨媒介实验计划", "围绕静态、动态、交互与未来视觉四个方向展开阶段性实验。"],
    ["2026-05", "开放合作", "面向品牌、空间、影像、界面与生成式视觉场景提供合作咨询。"],
  ],
};
